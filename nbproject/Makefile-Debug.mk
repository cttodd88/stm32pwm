...
# C Compiler Flags
CFLAGS=-mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -Wall -ffunction-sections -g -O0 -DSTM32F407VG -DSTM32F4XX -DUSE_STDPERIPH_DRIVER -D__ASSEMBLY__ -D__FPU_USED "-DUSE_TOUCH = 1" 
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32pwm: Lib/libSTemWin526_CM4_GCC.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32pwm: Lib/libSTemWin526_CM4_GCC_ot.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32pwm: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32pwm ${OBJECTFILES} ${LDLIBSOPTIONS} -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -g -nostartfiles -DSTM32F407VG -DSTM32F4XX -TSTM32F407VG_FLASH.ld -Wl,--gc-sections -g -o main.elf && arm-none-eabi-objcopy -Oihex main.elf main.hex

${OBJECTDIR}/Config/GUIConf.o: Config/GUIConf.c 
	${MKDIR} -p ${OBJECTDIR}/Config
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Config/GUIConf.o Config/GUIConf.c

${OBJECTDIR}/Config/GUIDRV_Template.o: Config/GUIDRV_Template.c 
	${MKDIR} -p ${OBJECTDIR}/Config
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Config/GUIDRV_Template.o Config/GUIDRV_Template.c

${OBJECTDIR}/Config/LCDConf_FlexColor_Template.o: Config/LCDConf_FlexColor_Template.c 
	${MKDIR} -p ${OBJECTDIR}/Config
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Config/LCDConf_FlexColor_Template.o Config/LCDConf_FlexColor_Template.c

${OBJECTDIR}/Config/SIMConf.o: Config/SIMConf.c 
	${MKDIR} -p ${OBJECTDIR}/Config
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Config/SIMConf.o Config/SIMConf.c
...
${OBJECTDIR}/cmsis_lib/source/stm32f4xx_exti.o: cmsis_lib/source/stm32f4xx_exti.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_exti.o cmsis_lib/source/stm32f4xx_exti.c

${OBJECTDIR}/cmsis_lib/source/stm32f4xx_fsmc.o: cmsis_lib/source/stm32f4xx_fsmc.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_fsmc.o cmsis_lib/source/stm32f4xx_fsmc.c
...
${OBJECTDIR}/cmsis_lib/source/stm32f4xx_pwr.o: cmsis_lib/source/stm32f4xx_pwr.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_pwr.o cmsis_lib/source/stm32f4xx_pwr.c
...
${OBJECTDIR}/cmsis_lib/source/stm32f4xx_rtc.o: cmsis_lib/source/stm32f4xx_rtc.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_rtc.o cmsis_lib/source/stm32f4xx_rtc.c

${OBJECTDIR}/cmsis_lib/source/stm32f4xx_spi.o: cmsis_lib/source/stm32f4xx_spi.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_spi.o cmsis_lib/source/stm32f4xx_spi.c

${OBJECTDIR}/cmsis_lib/source/stm32f4xx_syscfg.o: cmsis_lib/source/stm32f4xx_syscfg.c 
	${MKDIR} -p ${OBJECTDIR}/cmsis_lib/source
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmsis_lib/source/stm32f4xx_syscfg.o cmsis_lib/source/stm32f4xx_syscfg.c
...
${OBJECTDIR}/syscalls/syscalls.o: syscalls/syscalls.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/syscalls/syscalls.o syscalls/syscalls.c

${OBJECTDIR}/user/GUI_X_Touch.o: user/GUI_X_Touch.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/GUI_X_Touch.o user/GUI_X_Touch.c

${OBJECTDIR}/user/LCD_STM32F4.o: user/LCD_STM32F4.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/LCD_STM32F4.o user/LCD_STM32F4.c

${OBJECTDIR}/user/PlianHourHandbw.o: user/PlianHourHandbw.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/PlianHourHandbw.o user/PlianHourHandbw.c

${OBJECTDIR}/user/gui_x.o: user/gui_x.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/gui_x.o user/gui_x.c

${OBJECTDIR}/user/pwm.o: user/pwm.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/pwm.o user/pwm.c

${OBJECTDIR}/user/stm32f4xx_it.o: user/stm32f4xx_it.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/stm32f4xx_it.o user/stm32f4xx_it.c

${OBJECTDIR}/user/ts.o: user/ts.c 
	${MKDIR} -p ${OBJECTDIR}/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/ts.o user/ts.c
